...
const BASE_PRIORITIES: { id: string; title: string; description: string; isUpdate?: boolean }[] = [
  ...
  { id: "base-task-1-3-bio-cv-pitches", title: "Task 1.3 — Board of Director Biography/CV + 3 Sample Pitches (Update)", description: "Completed by Kiera H.: drafted a Biography/CV for Dr. Green tailored to Board of Director opportunities, plus three sample pitches ready to be sent to aligned organizations and institutions. Included at no additional charge as part of this month's priorities.", isUpdate: true },
  { id: "base-task-1-4-roadmap-10m", title: "Task 1.4 — Roadmap to $10M Strategy (Update — Pitch Only)", description: "Completed by Kiera H.: a roadmap to $10M that includes a grant track and a partnership strategy working with other entities. This is a strategy only — included for review and pitching, no action required from the Foundation.", isUpdate: true },
          ...
          <div className="mt-10 rounded-xl border border-[hsl(43,74%,52%)]/40 bg-black overflow-hidden">
            ...
            <div className="px-4 py-3 border-b border-[hsl(43,74%,52%)]/30 bg-[hsl(43,74%,49%)]/5">
              ...
              <ul className="text-xs text-white/75 space-y-1 list-disc pl-5">
                ...
                <li>Roadmap to $10M — includes a grant track and a partnership strategy with other entities. Strategy only; included to be pitched to the Foundation for review, no action required.</li>
              </ul>
            </div>
