    ...
    <>
      <SEOHead
        ...
        structuredData={{
          ...
          "publisher": { "@type": "Organization", "name": "Phresh Phactory, Inc.", "url": "https://phreshphactory.com" },
          "isPartOf": { "@type": "CollectionPage", "name": "Culture & Commerce", "url": "https://phreshphactory.com/cultureandcommerce" },
      ...
      <div className="min-h-screen bg-[#0b0b0d] text-white">
        ...
        <div className="relative h-[70vh]">
          {edition.cover_image && (
            <img src={edition.cover_image} alt={edition.title} className="absolute inset-0 w-full h-full object-cover opacity-25" />
          )}
