        ...
        <div className="container-custom relative z-10 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-2 md:order-1">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border border-white/20 shadow-2xl bg-gradient-to-br from-white via-white to-secondary-100">
                <img
                  src={kieraHost.url}
