...
const SocialShareButtons: React.FC<SocialShareButtonsProps> = ({ url, title, className = '' }) => {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      {/* Instagram */}
      <a href={shareLinks.instagram} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full border border-current/20 hover:border-primary hover:text-primary transition-colors" aria-label="Follow on Instagram">
      ...
      {/* TikTok */}
      <a href={shareLinks.tiktok} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full border border-current/20 hover:border-primary hover:text-primary transition-colors" aria-label="Follow on TikTok">
